...
from kedet.service import CLIError, cli, tasks as tasks_registry
...
from kedet.channels import AdPlatformTokenSideloadMixin, get_ad_platform
from kedet.logic import update_locations_database
from kedet.tasks import (
